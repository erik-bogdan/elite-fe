...
const data: Row[] = [
  ...
  { season: "2025 ŐSZ", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "HESSZ", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/hessz.png" }, third: [{ name: "KAKIMAKI", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/kakimaki.png" }, { name: "BORSOD BROTHERS", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/borsod-brothers.png" }] },
];
