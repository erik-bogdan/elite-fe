...
const data: Row[] = [
  ...
  { season: "2024-2025", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "KAKIMAKI", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/kakimaki.png" }, third: [{ name: "LEVEREGYBLANT", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/leveregyblant.png" }, { name: "CSICSKARÓLI", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/csicskaroli.png" }] },
  { season: "2025 ŐSZ", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "HESSZ", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/team-logos/hessz-IsXtKpyUSsJ99lylGWAPo.png" }, third: [{ name: "KAKIMAKI", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/kakimaki.png" }, { name: "BORSOD BROTHERS", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/team-logos/borsod-brothers-pQ-7VCJo9X6VZzm9sNKZq.png" }] },
];
