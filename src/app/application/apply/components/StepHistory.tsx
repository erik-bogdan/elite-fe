...
const data: Row[] = [
  ...
  { season: "2018-2019", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "B1", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/b1.png" }, third: [{ name: "LEVERGEYBLANT", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/leveregyblant.png" }, { name: "VILLÁMLOVAGOK", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/villamlovagok.png" }] },
  { season: "2019-2020", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "B1", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/b1.png" }, third: [{ name: "GIANTS", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/giants.png" }, { name: "LEVERGEYBLANT", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/leveregyblant.png" }] },
  ...
  { season: "2021-2022", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "GIANTS", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/giants.png" }, third: [{ name: "LEVERGEYBLANT", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/leveregyblant.png" }, { name: "STEEL CITY", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/steel-city.png" }] },
  { season: "2021-2022", first: { name: "AMÍG BEEROM", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/amig-beerom.png" }, second: { name: "GIANTS", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/giants.png" }, third: [{ name: "LEVERGEYBLANT", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/leveregyblant.png" }, { name: "STEEL CITY", logo: process.env.NEXT_PUBLIC_BACKEND_HOST + "/uploads/history/steel-city.png" }] },
